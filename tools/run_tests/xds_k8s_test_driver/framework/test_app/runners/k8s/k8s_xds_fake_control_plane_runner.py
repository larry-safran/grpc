...
class KubernetesFakeXdsControlPlaneRunner(k8s_base_runner.KubernetesBaseRunner):
    ...
    def __init__(  # pylint: disable=too-many-locals
            ...
            *,
            ...
            neg_name=None,
            network='default',
            deployment_template='fxcp.deployment.yaml',
            service_account_template='service-account.yaml',
            service_template='fxcp.service.yaml',
            reuse_service=False,
    ...
    def run(  # pylint: disable=arguments-differ,too-many-branches
            ...
            *,
            ...
            replica_count: int = 1,
            log_to_stdout: bool = False) -> List[FakeXdsControlPlaneServer]:
        ...
        logger.info(
            'Deploying fake xDS control plane "%s" to k8s namespace %s: test_port=%s '
        ...
        for pod in pods:
            ...
            servers.append(
              FakeXdsControlPlaneServer(ip=pod.status.pod_ip,
                              rpc_port=test_port,
    ...
    def make_namespace_name(cls,
                            ...
                            resource_suffix: str,
                            name: str = 'server') -> str:
        """A helper to make a consistent kubernetes namespace name
